...
' define brand colors
Const brandColor1 As String = "000,168,168"
Const brandColor2 As String = "052,024,082"
Const brandColor3 As String = "001,180,184"
Const brandColor4 As String = "119,094,136"

'Define the zoom level
Const sheetZoomLevel As Integer = 75
...
Sub Fmt_NumberFormat_N()
    ...
    Const numberFormat3 As String = "_(* #,##0_);_(* (#,##0);_(* """"-""""??_);_(@_)"
...
Sub Fmt_CycleFill_X()
    ...
    If isBrandColor Then
        color_1 = RGB(Left(brandColor1, 3), Mid(brandColor1, 5, 3), Right(brandColor1, 3))
        color_2 = RGB(Left(brandColor2, 3), Mid(brandColor2, 5, 3), Right(brandColor2, 3))
    Else
        color_1 = 15395562                        ' Light Yellow
        color_2 = 10092543                        ' Light Grey
    End If
...
Sub Fmt_CycleCellStyle_T()
    ...
    tmp = brandColor1                             ' <<<< Change this variable to change the dark cell color (ie. cellColor2)
    ...
    ElseIf Selection.Interior.Color = cellcolor1 And Selection.Font.Color = fontcolor1 And Selection.Font.Bold = False Then
        ...
        Selection.Font.Color = fontColor2
